...
My current research interests strongly lie in 3D computer vision & spatial reasoning, 6D pose estimation, <strong>vision-language-action(VLAs), world models & coding agents for 5D robot manipulation, test-time-adaptation,</strong> to leverage <strong>physical AI & embodied AI</strong>.<br> <br>
