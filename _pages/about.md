...
My current research interests strongly lie in 3D computer vision, <strong>embodied AI</strong>, 6D pose estimation, small language models (SLMs), and <strong>vision-language-action models (VLMs and VLAs)</strong> for robot manipulation and VLPs for autonomous systems, agentic AI.<br> <br>
