        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 0.76rem; text-align: left;" id="deadlines-table">
          ...
          <tbody>
            ...
            <tr class="category-header-row" data-category-header="robotics" style="background: var(--surface-2);">
              <td colspan="5" style="padding: 0.45rem 0.6rem; font-weight: 700; font-size: 0.72rem; color: var(--accent); letter-spacing: 0.03em; text-transform: uppercase;">
...
<div class="highlight-grid">
  <article class="highlight-card card reveal" data-delay="1">
    ...
    <div class="highlight-card__body">
      ...
      <div class="tag-list"><span class="tag">Vision-Language-Action</span><span class="tag">World Models</span><span class="tag">Agentic Robotics</span><span class="tag">Robot Learning</span><span class="tag">Causal Learning</span><span class="tag">Self Modeling</span><span class="tag">5D AI Robotics</span></div>
    </div>
  </article>
